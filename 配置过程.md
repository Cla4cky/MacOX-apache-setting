...
## 再次配置Apache
* 我们再次打开我们的“httpd.conf”，先看第52行代码有没有配置好apache的端口，如果出现打不开的问题我们可以来52行代码这修改端口，默认的端口是80.我们再看168行代码“#LoadModule rewrite_module libexec/apache2/mod_rewrite.so”。我们去掉前面的#，有的时候我们的apache出现403可以用这个不办法来防御（然后apache就会出现404了！但是我们还有别有办法来修复404！）
...
* 我们来到/private/etc/apache2/extra下找到httpd-vhosts.conf文件，我们打开他，我们配置VirtualHost里面的代码，首先是DocumentRoot我们修改为我们的根目录。然后我们添加一个directory代码如下：
* <Directory />
